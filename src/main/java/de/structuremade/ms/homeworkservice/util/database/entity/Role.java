...
public class Role {
    ...
    @JoinTable(name = "rolepermissions", schema = "services",
            joinColumns = @JoinColumn(name = "role", foreignKey = @ForeignKey(name = "fk_roleid"))
            , inverseJoinColumns = @JoinColumn(name = "permission", foreignKey = @ForeignKey(name = "fk_permissionid")))
